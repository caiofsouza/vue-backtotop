...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    visibleOffset: function visibleOffset(newVal) {
      document.body.style.height = newVal + 600;
    }
  },
  components: { BackToTop: __WEBPACK_IMPORTED_MODULE_0_vue_backtotop___default.a }
});
...
// module
exports.push([module.i, "*{box-sizing:border-box}body{height:2000px;background-color:#fcfcff}#app{font-family:Avenir,Helvetica,Arial,sans-serif;text-align:left;color:#2c3e50;margin-top:60px;max-width:980px;min-width:320px;margin:0 auto}h1{margin-top:100px;font-weight:600;font-size:40px;padding-bottom:20px;border-bottom:1px solid #2c3e50}.form-control{margin-bottom:20px}label{display:inline-block;margin-bottom:8px}input{border:1px solid #ccc;outline:none;padding:5px 15px 5px 10px;border-radius:3px;font-size:15px;width:200px;height:35px}", ""]);
...
// module
exports.push([module.i, ".back-to-top-fade-enter-active,.back-to-top-fade-leave-active{transition:opacity .7s}.back-to-top-fade-enter,.back-to-top-fade-leave-to{opacity:0}.vue-back-to-top{position:fixed;bottom:40px;right:30px;width:160px;color:#fff;text-align:center;line-height:30px;background-color:#f5c85c;border-radius:3px;z-index:1000;cursor:pointer}.vue-back-to-top span{color:#fff}", ""]);
